---
title: "MCP install guide - additional clients"
description: "This page documents how to register ai-memory as an MCP server with agent CLIs beyond the README quick start."
