...
description: "ai-memory completions <shell> prints a completion script to stdout for bash, zsh, fish, powershell, or elvish. The script is generated from the binary's own command tree, so it cov"
