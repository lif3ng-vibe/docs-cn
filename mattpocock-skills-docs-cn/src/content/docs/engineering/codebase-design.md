...
| The *words of the domain*: "account" means three things, two people mean different things by "cancellation" | [domain-modeling](/engineering/domain-modeling) |
| You don't yet know *which* module to redesign | [improve-codebase-architecture](/engineering/improve-codebase-architecture) (the survey that finds candidates) |
| You want the design argued with, not just named | [grilling](/productivity/grilling) |
| There's a concrete behaviour to build and you want tests that survive a refactor | [tdd](/engineering/tdd) |
