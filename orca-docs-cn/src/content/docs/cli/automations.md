...
description: "Scheduled automations — Orca documentation."
...
Use **Filters** to narrow the list by **Enabled** or **Paused** state, or by last-run outcome: **Failed**, **Succeeded**, or **Never ran**. The table shows the last-run result and relative time for each automation. Click the **Name** or **Last run** column to sort; name sorts alphabetically, while last run defaults to newest first.
