...
Remote/SSH sources still never open inside Orca's browser, even with the modifier. Terminal links can also open a click popover with **Orca Browser** / **System Browser** — see [Terminal → Link actions](/docs/terminal#link-actions).
