...
description: "Rich markdown editor — Orca documentation."
...
Use `/toggle-text` for collapsible notes, or `/toggle-h1` … `/toggle-h5` when the toggle summary should read like a heading level. Orca saves toggles as portable `<details>` / `<summary>` markdown so the file still previews outside Orca.
